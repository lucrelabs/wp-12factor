...
class Administrator extends InjectionAware
{
    ...
    public function addMenu()
    {
        ...
        add_menu_page(
            "WP-Staging", __("WP Staging " . $pro, "wp-staging"), "manage_options", "wpstg_clone",
            array($this, "getClonePage"), $logo
        );

        // Page: Clone
        add_submenu_page(
            "wpstg_clone", __("WP Staging Jobs", "wp-staging"), __("Sites / Start", "wp-staging"), "manage_options",
            "wpstg_clone", array($this, "getClonePage")
        );

        // Page: Settings
        add_submenu_page(
            "wpstg_clone", __("WP Staging Settings", "wp-staging"), __("Settings", "wp-staging"), "manage_options",
            "wpstg-settings", array($this, "getSettingsPage")
        );

        // Page: Tools
        add_submenu_page(
            "wpstg_clone", __("WP Staging Tools", "wp-staging"), __("Tools", "wp-staging"), "manage_options",
            "wpstg-tools", array($this, "getToolsPage")
        );

        if ( ! defined('WPSTGPRO_VERSION')) {
            // Page: Tools
            add_submenu_page(
                "wpstg_clone", __("WP Staging Welcome", "wp-staging"), __("Get WP Staging Pro", "wp-staging"),
                "manage_options", "wpstg-welcome", array($this, "getWelcomePage")
            );
        }
        ...
        if (defined('WPSTGPRO_VERSION') && false === wpstg_is_stagingsite()) {
            // Page: License
            add_submenu_page(
                "wpstg_clone", __("WP Staging License", "wp-staging"), __("License", "wp-staging"), "manage_options",
                "wpstg-license", array($this, "getLicensePage")
            );
        }
    }
