...
if ( class_exists( 'Iconic_WBP_Core_Licence' ) ) {
    return;
}
/**
 * Iconic_WBP_Core_Licence.
 *
...
class Iconic_WBP_Core_Licence
{
    ...
    {
        return $html . sprintf( '<a href="%s" class="button button-secondary">&larr; %s</a>', self::$args['urls']['settings'], __( 'Back to Settings', 'iconic-woo-bundled-products' ) );
    }
    ...
    {
        if ( !Iconic_WBP_Core_Settings::is_settings_page( '-account' ) ) {
            return;
        }
        ?>
    ...
    {
        $links[] = sprintf( '<a href="%s" target="_blank">%s</a>', self::$args['urls']['product'] . '/changelog/?utm_source=iconic-woo-bundled-products&utm_medium=insideplugin', __( 'Changelog', 'iconic-woo-bundled-products' ) );
        return $links;
    }
    ...
    {
        return sprintf( '<a href="%s" class="button button-secondary">%s</a>', self::$args['urls']['account'], __( 'Manage Licence &amp; Billing', 'iconic-woo-bundled-products' ) );
    }
