...
if ( class_exists( 'Iconic_WBP_Core_Cross_Sells' ) ) {
	return;
}

/**
 * Iconic_WBP_Core_Cross_Sells.
 *
 * @class    Iconic_WBP_Core_Cross_Sells
 * @version  1.0.0
 * @category Class
 * @author   Iconic
 */
class Iconic_WBP_Core_Cross_Sells {
	/**
	 * Single instance of the Iconic_WBP_Core_Licence object.
	 *
	 * @var Iconic_WBP_Core_Licence
	 */
	...
	/**
	 * Creates/returns the single instance Iconic_WBP_Core_Licence object.
	 *
	 * @return Iconic_WBP_Core_Licence
	 */
	...
	/**
	 * Iconic_WBP_Core_Cross_Sells constructor.
	 */
	...
	private static function get_plugins() {
		return array(
			'iconic-woo-show-single-variations'       => array(
				...
				'description' => __( 'Display individual product variations of a variable product in your product listings. Make it easy for your customers to view and filter product variations.', 'iconic-woo-bundled-products' ),
			...
			'iconic-woothumbs'                        => array(
				...
				'description' => __( 'Enable zoom, sliders, video, fullscreen, multiple images per variation, and customisable layout options for your product imagery.', 'iconic-woo-bundled-products' ),
			...
			'iconic-woo-delivery-slots'               => array(
				...
				'description' => __( 'Choose a delivery date and time for each order. Add a limit to the number of allowed reservations, restrict time slots to specific delivery methods, and so much more.', 'iconic-woo-bundled-products' ),
			...
			'iconic-woo-linked-variations'            => array(
				...
				'description' => __( 'Link a group of WooCommerce products together by their attributes; a new way to handle product variations.', 'iconic-woo-bundled-products' ),
			...
			'iconic-woo-product-configurator'         => array(
				...
				'description' => __( 'Use transparent image layers for your variable products, removing the need to create hundreds of final product variation images.', 'iconic-woo-bundled-products' ),
			...
			'iconic-woo-quicktray'                    => array(
				...
				'description' => __( 'A modern take on quick view for WooCommerce; expand product details within your product listings for a convenient shopping experience.', 'iconic-woo-bundled-products' ),
			...
			'iconic-woo-account-pages'                => array(
				...
				'description' => __( 'Add and manage pages in your WooCommerce "My Account" area using the native WordPress "Pages" functionality.', 'iconic-woo-bundled-products' ),
			...
			'iconic-woo-quickview'                    => array(
				...
				'description' => __( 'Quickly view any product from the catalog, without reloading the page. Encourage sales with easy and efficient product browsing.', 'iconic-woo-bundled-products' ),
			...
			'iconic-woo-attribute-swatches'           => array(
				...
				'description' => __( 'Bored of the standard dropdown fields when viewing a variable product? Turn them into colour, image, or text swatches!', 'iconic-woo-bundled-products' ),
			...
			'iconic-woo-custom-fields-for-variations' => array(
				...
				'description' => __( 'Easily add custom fields to your product variations; the perfect way to display organised additional product data to your customers.', 'iconic-woo-bundled-products' ),
			...
			'iconic-woo-bundled-products'             => array(
				...
				'description' => __( 'Bundle a selection of products on a single product page. It even works with variable products!', 'iconic-woo-bundled-products' ),
	...
	public static function get_output() {
		...
		$utm = '?utm_source=iconic-woo-bundled-products&utm_medium=dashboard&utm_campaign=cross-sell';
		...
		<div class="iconic-cross-sells-wrapper">
			<div class="iconic-cross-sells-columns iconic-cross-sells-columns--plugins">
							...
							<div class="iconic-cross-sell__border">
								...
								<div class="iconic-cross-sell__footer">
									<a class="iconic-cross-sell__link button-secondary" href="<?php echo esc_attr( $cross_sell['url'] . $utm ); ?>" target="_blank">
										<?php _e( 'Learn More', 'iconic-woo-bundled-products' ); ?>
				...
				<a href="https://iconicwp.com/products<?php echo esc_attr( $utm ); ?>" class="button-secondary"><?php _e( 'View All Iconic Plugins', 'iconic-woo-bundled-products' ); ?></a>
			</div>
