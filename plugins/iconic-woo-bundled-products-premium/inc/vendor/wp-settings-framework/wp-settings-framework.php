...
if ( ! class_exists( 'Iconic_WBP_Settings_Framework' ) ) {
	/**
	 * Iconic_WBP_Settings_Framework class
	 */
	class Iconic_WBP_Settings_Framework {
		/**
		 * @access private
		 * @var array
		 */
		...
		/**
		 * Iconic_WBP_Settings_Framework constructor.
		 *
