...
class XA_Object implements \ArrayAccess, \Iterator
{
    /**
     * @var string
     */
    ...
    public function _toJSON()
    {
        if (defined('JSON_PRETTY_PRINT')) {
            ...
            return json_encode($this->_toArray(true), JSON_PRETTY_PRINT);
        }

        return json_encode($this->_toArray(true));
    }
     ...
     * @return array
     */
    public function _toArray($recursive = false)
    {
        if ($recursive) {
