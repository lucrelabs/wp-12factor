...
final class WC_Vendors_Stripe_Connect_Gateway {
	...
	public function debug_tools( $tools ) {
		$tools['clear-stripe-connect-cache'] = array(
			'name'     => __( 'Clear Stripe Connect cache', 'wc-vendors-stripe-connect' ),
			'desc'     => __( 'This will delete Stripe Account country cache.', 'wc-vendors-stripe-connect' ),
			'button'   => __( 'Clear cache', 'wc-vendors-stripe-connect' ),
...
function wcv_sc_admin_notices_v1() {
	...
	<div class="notice notice-error">
		<p><?php _e( 'Old version found! Please remove WC Vendors - Stripe Commissions & Gateway to use the new version.', 'wc-vendors-stripe-connect' ); ?></p>
	</div>
	<?php
}
