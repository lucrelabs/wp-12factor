	...
	public function display_order_fee( $order_id ) {
		...
		<tr>
			<td class="label stripe-fee">
				<?php echo wc_help_tip( __( 'This represents the fee Stripe collects for the transaction.', 'wc-vendors-stripe-connect' ) ); // wpcs: xss ok. ?>
				<?php esc_html_e( 'Stripe Fee:', 'wc-vendors-stripe-connect' ); ?>
			</td>
			<td width="1%"></td>
			<td class="total">
