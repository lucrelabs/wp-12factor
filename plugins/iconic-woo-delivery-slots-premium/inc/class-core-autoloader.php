...
if ( class_exists( 'Iconic_WDS_Core_Autoloader' ) ) {
	return;
}

/**
 * Iconic_WDS_Core_Autoloader.
 *
 * @class    Iconic_WDS_Core_Autoloader
 * @version  1.0.1
 * @author   Iconic
 */
class Iconic_WDS_Core_Autoloader {
	/**
	 * Single instance of the Iconic_WDS_Core_Autoloader object.
	 *
	 * @var Iconic_WDS_Core_Autoloader
	 */
	...
	/**
	 * Creates/returns the single instance Iconic_WDS_Core_Autoloader object.
	 *
	 * @return Iconic_WDS_Core_Autoloader
	 */
