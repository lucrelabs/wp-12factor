...
if ( ! class_exists( 'Iconic_WDS_Settings_Framework' ) ) {
	/**
	 * Iconic_WDS_Settings_Framework class
	 */
	class Iconic_WDS_Settings_Framework {
		/**
		 * @access private
		 * @var array
		 */
		...
		/**
		 * Iconic_WDS_Settings_Framework constructor.
		 *
